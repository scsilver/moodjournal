...
RSpec.describe "inquirer_class_databases/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit inquirer_class_database form" do
    render

    assert_select "form[action=?][method=?]", inquirer_class_database_path(@inquirer_class_database), "post" do
